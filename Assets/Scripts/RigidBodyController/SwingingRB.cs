...
public class SwingingRB : MonoBehaviour
{
    [Header("References")]
    ...
    [Header("Input")]
    PlayerInputHandlerRB inputHandler;
    ...
    private void Update()
    {
        if (inputHandler.IsSwingingPressed) StartSwing();
        if (inputHandler.IsSwingingReleased) StopSwing();
    ...
    {
        inputHandler.IsSwingingPressed = false;
        inputHandler.IsSwingingReleased = false;
    }
    ...
    private void StartSwing()
    {
        ...
        if (GetComponent<GrapplingRB>() != null)
